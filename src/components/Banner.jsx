                ...
                <div className='flex flex-col space-y-5 items-baseline w-1/2'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className='flex items-center gap-2'>
                            <button className='p-3 bg-black hover:bg-slate-800 text-white font-bold text-sm'>
                                Chi tiết
                            </button>
                            <button className='p-3 bg-red-600 hover:bg-red-500 text-white font-bold text-sm'>
                                Xem phim
                            </button>
                        </div>
                    </div>
